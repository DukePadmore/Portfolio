    ...
    <section className='section about' id='about'>
      <div className='about__box'>
        ...
        <p className='about__desc'>
          Hi ! My name is Duke and I am a French junior front-end developer who
          will soon be relocating to Canada. After almost 10 years of experience
          in Retail and Procurement, I decided to transition to a new career in
          a field that has fascinated me for many years now: Web Development.
        </p>
        <p className='about__desc'>
