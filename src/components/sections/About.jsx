  ...
  return (
    <section className='section' id='about'>
      ...
      <p>
        ...
        ready to take on new and exciting challenges as a web developer in
        Canada. With a strong interest for anything related to front-end, my
        goal is to create intuitive, carefully designed websites.
      </p>
    </section>
  );
}
