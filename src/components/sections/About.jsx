    ...
    <section className='section about' id='about'>
      <div className='about__box'>
        ...
        <p className='about__desc'>
          ...
          will soon relocate to Canada. After almost 10 years of experience in
          Retail and Procurement, I decided to transition to a new career in a
          field that has fascinated me for many years now: Web Development.
        </p>
        <p className='about__desc'>
